public extension Remark {
    ...
    enum LowCloudType: String, Codable, RegexCases, Sendable {
    ...
    enum MiddleCloudType: String, Codable, RegexCases, Sendable {
    ...
    enum HighCloudType: String, Codable, RegexCases, Sendable {
