extension Remark {
    ...
    public enum LowCloudType: String, Codable, RegexCases, Sendable {
    ...
    public enum MiddleCloudType: String, Codable, RegexCases, Sendable {
    ...
    public enum HighCloudType: String, Codable, RegexCases, Sendable {
