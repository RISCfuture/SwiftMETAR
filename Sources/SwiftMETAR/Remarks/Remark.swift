...
public enum Remark: Codable, Equatable, Sendable {
   ...
   */
  case observedPrecipitation(
    type: ObservedPrecipitationType,
    proximity: Proximity?,
    directions: Set<Direction>
  )
   ...
   */
  case tornadicActivity(
    type: TornadicActivityType,
...
public struct RemarkEntry: Codable, Equatable, Sendable {
