...
extension FormatStyle where Self == Icing.IcingType.FormatStyle {
  public static var type: Self { .init() }

  public static func type(includeIcing: Bool = false) -> Self {
