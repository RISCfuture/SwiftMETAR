  ...
  public struct FormatStyle: Foundation.FormatStyle, Sendable {
    ...
    public func format(_ value: Weather.Descriptor) -> String {
      switch value {
        ...
        case .thunderstorms:
          String(localized: "thunderstorm-associated", comment: "precipitation descriptor")
...
extension FormatStyle where Self == Weather.Descriptor.FormatStyle {
  public static func descriptor(phenomenon: Weather.Phenomenon) -> Self {
