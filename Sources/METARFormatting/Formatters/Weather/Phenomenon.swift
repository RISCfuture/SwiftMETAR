    ...
    public func format(_ value: Weather.Phenomenon) -> String {
      switch value {
        ...
        case .unknownPrecipitation:
          String(localized: "unknown precipitation", comment: "weather phenomenon")
...
extension FormatStyle where Self == Weather.Phenomenon.FormatStyle {
  public static var phenomenon: Self { .init() }
}
