...
extension Remark.NavalWeatherCenter {
      ...
      switch width {
        ...
        case .full:
          switch value {
            case .sanDiego:
              String(
                localized: "Fleet Naval Weather Center San Diego",
                comment: "naval weather center"
              )
            case .norfolk:
              String(
                localized: "Fleet Naval Weather Center Norfolk",
                comment: "naval weather center"
              )
          }
      }
...
extension FormatStyle where Self == Remark.NavalWeatherCenter.FormatStyle {
  public static var navalWeatherCenter: Self { .init() }

  public static func navalWeatherCenter(width: Remark.NavalWeatherCenter.FormatStyle.Width) -> Self
  {
    .init(width: width)
  }
}
