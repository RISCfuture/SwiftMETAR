  ...
  public struct FormatStyle: Foundation.FormatStyle, Sendable {
    public func format(_ value: Remark.LowCloudType) -> String {
      switch value {
        ...
        case .cuMedCon:
          String(localized: "cumulus mediocris or congestus", comment: "low cloud type")
        ...
        case .scNonCugen:
          String(localized: "stratocumulus non-cumulogenitus", comment: "low cloud type")
...
extension Remark.MiddleCloudType {
  ...
  public struct FormatStyle: Foundation.FormatStyle, Sendable {
    public func format(_ value: Remark.MiddleCloudType) -> String {
      switch value {
        ...
        case .acCugenCbgen:
          String(
            localized: "altocumulus cumulogenitus/cumulonimbogenitus",
            comment: "middle cloud type"
          )
        case .acAsNsOp:
          String(localized: "altocumulus translucidus/opacus", comment: "middle cloud type")
        case .acCasFlo:
          String(localized: "altocumulus castellanus/floccus", comment: "middle cloud type")
        case .acChaoticSky:
          String(localized: "altocumulus chaotic sky", comment: "middle cloud type")
      }
    }
  }
}

extension Remark.HighCloudType {
  ...
  public struct FormatStyle: Foundation.FormatStyle, Sendable {
    public func format(_ value: Remark.HighCloudType) -> String {
      switch value {
        ...
        case .ciSpi:
          String(
            localized: "cirrus spissatus non-cumulonimbogenitus/castellanus/floccus",
            comment: "high cloud type"
          )
        case .ciSpiCb:
          String(localized: "cirrus spissatus cumulonimbogenitus", comment: "high cloud type")
        case .ciUncFib: String(localized: "cirrus uncinus/fibratus", comment: "high cloud type")
        case .csLess45:
          String(
            localized: "cirrostratus extending <45° above the horizon",
            comment: "high cloud type"
          )
        case .csGreater45:
          String(
...
extension FormatStyle where Self == Remark.LowCloudType.FormatStyle {
  public static var lowClouds: Self { .init() }
}

extension FormatStyle where Self == Remark.MiddleCloudType.FormatStyle {
  public static var middleClouds: Self { .init() }
}

extension FormatStyle where Self == Remark.HighCloudType.FormatStyle {
  public static var highClouds: Self { .init() }
}
