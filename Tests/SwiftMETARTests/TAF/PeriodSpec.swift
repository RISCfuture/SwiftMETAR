  ...
  override class func spec() {
    it("parses TAF with group that crosses month boundary") {
      let string = """
        ...
        OVC040 FM311900 13008KT P6SM VCSH SCT030 OVC050 FM312200 12009KT P6SM SCT030 BKN060 \
        FM010800 23010KT P6SM -SHRA VCTS SCT040 OVC050CB PROB30 0108/0112 4SM -TSRA BR OVC040CB
        """
