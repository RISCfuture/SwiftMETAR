    ...
    override class func spec() {
        describe("runway visibility") {
            ...
            it("parses a 'VIS 1/2 RWY11' remark") {
                ...
                expect(observation.remarks.map { $0.remark }).to(contain(.runwayVisibility(runway: "11", distance: 1/2 as Ratio)))
            }
            ...
            it("parses a 'VIS 1 RWY11' remark") {
                ...
                expect(observation.remarks.map { $0.remark }).to(contain(.runwayVisibility(runway: "11", distance: 1 as Ratio)))
            }
        }
    }
}
