    ...
    override class func spec() {
        describe("variable prevailing visibility") {
            ...
            it("parses a 'VIS 1/2V5' remark") {
                ...
                expect(observation.remarks.map { $0.remark }).to(contain(.variablePrevailingVisibility(low: 1/2 as Ratio, high: 5 as Ratio)))
            }
            ...
            it("parses a 'VIS 2V4' remark") {
                ...
                expect(observation.remarks.map { $0.remark }).to(contain(.variablePrevailingVisibility(low: 2 as Ratio, high: 4 as Ratio)))
            }
        }
    }
}
