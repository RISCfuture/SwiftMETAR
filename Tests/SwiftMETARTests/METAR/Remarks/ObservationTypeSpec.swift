    ...
    describe("observation type") {
      it("parses a 'AO1' remark") {
        ...
        expect(observation.remarks.map(\.remark)).to(
          contain(.observationType(.automated, augmented: false))
        )
      }
      ...
      it("parses a 'AO2' remark") {
        ...
        expect(observation.remarks.map(\.remark)).to(
          contain(.observationType(.automatedWithPrecipitation, augmented: false))
        )
      }
      ...
      it("parses a 'AO2A' remark") {
        ...
        expect(observation.remarks.map(\.remark)).to(
          contain(.observationType(.automatedWithPrecipitation, augmented: true))
        )
      }
    }
  }
